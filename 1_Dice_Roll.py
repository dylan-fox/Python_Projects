...
for basic concepts. And if you already have programming experience, chances are
that the concepts used in this project aren’t completely foreign to you. Print,
for example, is similar to Javascript’s console.log."""

def simple_addition(a, b):
	sum = a+b
	return sum

print simple_addition(5,6)
